...
class DropDownMenu extends React.Component {
  ...
  handleLeftContentcontainerClass = () => {
    ...
    let leftContentcontainerClass = leftContentIsSplitted
      ? 'left-content-container-split'
      : 'left-content-container';
    leftContentcontainerClass +=
      isContentCompleted || isDroppedDown ? ' left-content-container-selected' : '';
  ...
  render() {
    ...
    return (
      <div styleName={classNames('dropdown-menu')}>
        <div
